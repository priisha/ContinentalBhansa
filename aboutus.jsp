...
<div class="container">
    ...
    <section class="story">
        ...
        <p>
            Drawing subtle inspiration from cozy urban cafés, we brought together warm interiors, communal tables, and hearty continental flavors to offer a home away from home. Whether it's brunch with friends or a solo evening meal, our space is designed to make every guest feel like they belong.
        </p>
    </section>
    ...
    <footer>
        <p>© 2025 Continental Bhanchaa | All rights reserved.</p>
    </footer>
</div>
</body>
